...
const Sidebar = () => {
  const { activeMenu, setActiveMenu, screenSize } = useStateContext(); // create a hook
        ...
        items-center'>
          ...
          position="BottomCenter">
            <button type="button"
              ...
              (prevActiveMenu) => 
              !prevActiveMenu)} // set the menu on and off and the cancel icon is active.                                                   // cancel icon is active 
